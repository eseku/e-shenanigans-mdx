...
const ThemeChanger = () => {
  ...
  return (
    <div style={{ outline: 'none !important', border: 'none !important' }}>
      <Icon theme={currentTheme.name} toggleTheme={toggleTheme} width={width} />
    </div>
  )
}
...
function Icon({ theme, toggleTheme, width }) {
  return (
    <StyledToggler
      onClick={() => {
        toggleTheme()
